...
export interface ISolidStateERC1155Interface extends utils.Interface {
  functions: {
...
export interface ISolidStateERC1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISolidStateERC1155Interface;
