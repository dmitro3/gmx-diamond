...
import type {
  ISolidStateERC1155,
  ISolidStateERC1155Interface,
} from "../../../../../@solidstate/contracts/token/ERC1155/ISolidStateERC1155";
...
export class ISolidStateERC1155__factory {
  static readonly abi = _abi;
  static createInterface(): ISolidStateERC1155Interface {
    return new utils.Interface(_abi) as ISolidStateERC1155Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISolidStateERC1155 {
    return new Contract(address, _abi, signerOrProvider) as ISolidStateERC1155;
  }
}
